...
INSERT INTO Customers VALUES (1, 'Siri', 'siri@example.com');
INSERT INTO Customers VALUES (2, 'Akshaya', 'akshaya@example.com');
COMMIT;
...
BEGIN
    ...
    AddNewCustomer(1, 'Siri another', 'another@example.com');
